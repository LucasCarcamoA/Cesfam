...
def index(request):
    ...
    """
    Renderiza la página de inicio con las noticias, eventos y campañas más recientes.

    Args:
        request: Objeto HTTP request.

    Returns:
        HttpResponse: Página de inicio con los datos pasados al contexto.
    """
...
def ubicacion(request):
    """
    Renderiza la página de ubicación con logos de instituciones relacionadas.

    Args:
        request: Objeto HTTP request.

    Returns:
        HttpResponse: Página de ubicación con los datos pasados al contexto.
    """
    data = {
        'logosamu':'/static/img/logosamu.png',
        'logobomberos':'/static/img/logobomberos.png',
